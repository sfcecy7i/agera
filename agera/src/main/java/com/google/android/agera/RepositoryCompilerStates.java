...
public interface RepositoryCompilerStates {
  ...
  interface RConfig<TVal> {
     ...
     * buffer for the next repository to implementation (the {@code mainRepository}), with its own event
     ...
     * flow, the next repository to implementation has no access to its previous value. Additionally, the
