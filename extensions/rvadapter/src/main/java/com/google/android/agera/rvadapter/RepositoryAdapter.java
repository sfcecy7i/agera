...
public class RepositoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
  ...
  public static final class Builder {
    ...
    @TargetApi(14)
    @NonNull
    public RecyclerView.Adapter<RecyclerView.ViewHolder> whileResumed(@NonNull final Activity activity) {
    ...
    @TargetApi(14)
    @NonNull
    public RecyclerView.Adapter<RecyclerView.ViewHolder> whileStarted(@NonNull final Activity activity) {
      final RepositoryAdapter repositoryAdapter = new RepositoryAdapter(this);
      activity.getApplication().registerActivityLifecycleCallbacks(
  ...
  private abstract static class Part {
    ...
    abstract void bind(final int index, @NonNull final RecyclerView.ViewHolder holder);

    abstract void recycle(@NonNull final RecyclerView.ViewHolder holder);
  ...
  private static final class RepositoryPart extends Part implements Updatable {
    ...
    @Override
    void bind(final int index, @NonNull final RecyclerView.ViewHolder holder) {
      presenter.bind(data, index, holder);
    }

    @Override
    void recycle(@NonNull final RecyclerView.ViewHolder holder) {
